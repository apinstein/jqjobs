...
abstract class BaseJQStoreManagedJob extends BaseObject implements Persistent
{
    ...
    /**
     * The value for the work_factor field.
     * @var        int
     */
    protected $work_factor;
    ...
    /**
     * Get the [work_factor] column value.
     *
     * @return int
     */
    public function getWorkFactor()
    {
        return $this->work_factor;
    }
    ...
    /**
     * Set the value of [work_factor] column.
     *
     * @param int $v new value
     * @return JQStoreManagedJob The current object (for fluent API support)
     */
    public function setWorkFactor($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->work_factor !== $v) {
            $this->work_factor = $v;
            $this->modifiedColumns[] = JQStoreManagedJobPeer::WORK_FACTOR;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->work_factor = ($row[$startcol + 12] !== null) ? (int) $row[$startcol + 12] : null;
            $this->resetModified();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(JQStoreManagedJobPeer::WORK_FACTOR)) {
            $modifiedColumns[':p' . $index++]  = 'WORK_FACTOR';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'STATUS':
                        ...
                        break;
                    case 'WORK_FACTOR':
                        $stmt->bindValue($identifier, $this->work_factor, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[12], $arr)) $this->setWorkFactor($arr[$keys[12]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(JQStoreManagedJobPeer::WORK_FACTOR)) $criteria->add(JQStoreManagedJobPeer::WORK_FACTOR, $this->work_factor);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setWorkFactor($this->getWorkFactor());
        if ($makeNew) {
            $copyObj->setNew(true);
